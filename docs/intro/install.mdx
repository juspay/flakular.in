...
For a pleasant nix development environment experience, install [nix-direnv & starship](/direnv). We also recommend [nixos-flake](/nixos-flake) if you are using Nix to manage system or home configuration.
