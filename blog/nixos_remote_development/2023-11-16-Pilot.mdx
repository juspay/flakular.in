...
Have you ever worked on a project that takes forever to compile? Or maybe you just want to compile for linux while working on a Mac. If yes, then this post is for you.
